...
var wasmSourceMapFile = 'privid_fhe.wasm.map';
if (!isDataURI(wasmBinaryFile)) {
...
var ASM_CONSTS = {
  9530964: () => { FS.mkdir('/privid'); FS.mount(IDBFS, {}, '/privid'); FS.syncfs(true, function (err) { assert(!err); }); },  
 9531068: () => { FS.syncfs(function (err) { }); }
};
...
var ___start_em_js = Module['___start_em_js'] = 9530516;
var ___stop_em_js = Module['___stop_em_js'] = 9530964;
