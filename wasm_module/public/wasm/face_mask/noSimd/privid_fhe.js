...
var ASM_CONSTS = {
  10437924: () => { FS.mkdir('/privid'); FS.mount(IDBFS, {}, '/privid'); FS.syncfs(true, function (err) { assert(!err); }); },  
 10438028: () => { FS.syncfs(function (err) { }); }
};
...
var ___start_em_js = Module['___start_em_js'] = 10437476;
var ___stop_em_js = Module['___stop_em_js'] = 10437924;
