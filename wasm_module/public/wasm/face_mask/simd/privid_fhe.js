...
var ASM_CONSTS = {
  9530644: () => { FS.mkdir('/privid'); FS.mount(IDBFS, {}, '/privid'); FS.syncfs(true, function (err) { assert(!err); }); },  
 9530748: () => { FS.syncfs(function (err) { }); }
};
...
var ___start_em_js = Module['___start_em_js'] = 9530196;
var ___stop_em_js = Module['___stop_em_js'] = 9530644;
