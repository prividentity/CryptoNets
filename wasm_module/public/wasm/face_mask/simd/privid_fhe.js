...
var ASM_CONSTS = {
  10495556: function() {FS.mkdir('/privid'); FS.mount(IDBFS, {}, '/privid'); FS.syncfs(true, function (err) { assert(!err); });},  
 10495660: function() {FS.syncfs(function (err) { });}
};
...
/** @type {function(...*):?} */
var __Z34privid_barcode_extract_pdf417fieldPciS_iPS_Pi = Module["__Z34privid_barcode_extract_pdf417fieldPciS_iPS_Pi"] = function() {
  return (__Z34privid_barcode_extract_pdf417fieldPciS_iPS_Pi = Module["__Z34privid_barcode_extract_pdf417fieldPciS_iPS_Pi"] = Module["asm"]["_Z34privid_barcode_extract_pdf417fieldPciS_iPS_Pi"]).apply(null, arguments);
};
