...
var ASM_CONSTS = {
  10437604: () => { FS.mkdir('/privid'); FS.mount(IDBFS, {}, '/privid'); FS.syncfs(true, function (err) { assert(!err); }); },  
 10437708: () => { FS.syncfs(function (err) { }); }
};
...
var ___start_em_js = Module['___start_em_js'] = 10437156;
var ___stop_em_js = Module['___stop_em_js'] = 10437604;
